...
import ru.rusguardian.open.ai.service.service.dto.speech.OpenAiCreateSpeechRequestDto;
...
public class GetSpeechService {
    ...
    public GetSpeechService(@Qualifier("openAIWebClient") WebClient webClient) {
