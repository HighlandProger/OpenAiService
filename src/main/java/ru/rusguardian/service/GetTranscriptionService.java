...
import ru.rusguardian.service.dto.transcription.OpenAiTranscriptionRequestDto;
import ru.rusguardian.service.dto.transcription.OpenAiTranscriptionResponseDto;
...
public class GetTranscriptionService {
    ...
    public GetTranscriptionService(@Qualifier("openAITextWebClient") WebClient webClient) {
